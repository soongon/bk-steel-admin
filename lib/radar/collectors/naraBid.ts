...
// 제외: 비철근 공종 + 비건물 철거(지장물·과속방지턱·슬레이트 등) + 비공사(설계/감리/용역 등).
const NARA_EXCLUDE = ["전기", "통신", "조경", "식재", "수목", "청소", "소독", "방역", "방제", "제초", "임도", "사방", "준설", "퇴적", "오니", "방수", "도장", "포장", "아스팔트", "표지", "신호등", "CCTV", "cctv", "제설", "벌목", "간판", "현수막", "석면", "폐기물", "설계", "감리", "측량", "용역", "임대", "매각", "점검", "진단", "설비", "냉난방", "승강기", "기계설비"];
...
// 비건물 철거(도로변 구조물·지붕재 등) — 건물 키워드가 섞여 있어도 우선 컷.
const NARA_DEMO_NONBUILDING = ["지장물", "과속방지턱", "방지턱", "슬레이트", "수목", "벌목", "가로등", "전주", "표지", "펜스", "휀스", "담장", "축대", "옹벽", "도로", "포장", "보도", "맨홀"];
